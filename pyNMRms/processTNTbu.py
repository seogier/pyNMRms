...
class TNTfile:
    ...
    def __init__(self, tntfilename):
        ...
        with open(tntfilename, 'rb') as tntfile:
            ...
            dealyorloopre=b'((de|lp)[0-9]+:[0-9])|TI_[1-9]|ti_times|cpmgloop|gr0:2|GxTable|GyTable|gztable|rdArray|seloop|HPMW|TX3:2'   #match de0:0 or lp0:0 or TI_0 or ti_times or cpmgloop or gr0:2
