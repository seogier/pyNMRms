...
class TNTfile:
    ...
    def __init__(self, tntfilename):
        ...
        with open(tntfilename, 'rb') as tntfile:
            ...
            dealyorloopre=b'((at|lp)[0-9]+:[0-9])|((de|lp)[0-9]+:[0-9])|TI_[1-9]|ti_times|cpmgloop|gr0:2|GxTable|GyTable|gztable|rdArray|seloop|HPMW|RFattnDB|teDelay|tiDelay|sliceFrequencies|gradRingdownDelay|tau_array'   #match de0:0 or lp0:0 or TI_0 or ti_times or cpmgloop or gr0:2
            ...
            try:
                ...
                try:        #pull out comment, get rid of nonascii and line feeds
                    ...
                    if self.TNMRComment.find('Slice Offset')>-1:
                        ...
                        self.TNMRComment=str(re.sub(r'[^a-zA-Z0-9;=();:.]', '', self.TNMRComment))       #get rid of all nonascii characters
